# -*- coding: utf-8 -*-
"""
Created on Sat Aug 10 10:48:07 2019

@author: ASUS
"""'C:/用户/ASUS/.spyder-py3/Iris.data'
...
#3.训练svm分类器
classifier=svm.SVC(C=2,kernel='rbf',gamma=12,decision_function_shape='ovo') # ovr:一对多策略
...
plt.show()
'''--------------------- 
版权声明：本文为CSDN博主「大姨妈V」的原创文章，遵循CC 4.0 by-sa版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/u012679707/article/details/80511968'''
